...
millet:{id:'millet',name:'粟米',cat:'basic',icon:'🌾'},roots:{id:'roots',name:'根菜',cat:'basic',icon:'🥕'},lumber:{id:'lumber',name:'木料',cat:'basic',icon:'🌲'},clay:{id:'clay',name:'黏土',cat:'basic',icon:'🧱'},glass:{id:'glass',name:'玻璃',cat:'basic',icon:'🍶'},ink:{id:'ink',name:'墨',cat:'basic',icon:'🖋'},fishnet:{id:'fishnet',name:'渔网',cat:'basic',icon:'🎣'},stone:{id:'stone',name:'石材',cat:'basic',icon:'⛰️'},tar:{id:'tar',name:'焦油',cat:'basic',icon:'🛢️'},linen:{id:'linen',name:'亚麻布',cat:'basic',icon:'🎽'},
